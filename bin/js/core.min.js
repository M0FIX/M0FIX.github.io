...
function initQuill() {
    ...
    function l(t, e, l) {
        ...
        if (i = c[0])(!i.prev || i.prev instanceof BreakBlot) && (a.scroll.deleteAt(--r, 1), s = !0);
        else {
        ...
        if (i = f[0], i || s || !t) a.insertText(r, "\n", Quill.sources.USER), a.setSelection(++r, Quill.sources.USER), (l.format.blockHeader || l.format.blockSubheader || l.format.blockBlockquote || l.format.blockPullquote) && n && a.formatLine(r, 1, {
            blockHeader: !1,
            blockSubheader: !1,
            blockBlockquote: !1,
            blockPullquote: !1
            ...
            i = _[0], !i || i.next || i.prev && i.prev instanceof BreakBlot || (a.insertEmbed(++r, "textBreak", !0, Quill.sources.SILENT), a.setSelection(r, 0, Quill.sources.SILENT))
        }
                    ...
                    "required enter": {
                        ...
                        handler: function(t, e) {
                            var o = this.quill.scroll.descendant(FieldBlot, t.index),
                                ...
                                i = l[0];
                            return i && i.next && !$(i.next.domNode).text() ? (this.quill.setSelection(i.next.offset(this.quill.scroll), 0, Quill.sources.USER), !1) : (this.quill.insertText(t.index, "\n", Quill.sources.USER), !1)
                        }
                    },
                    "required tab prev": {
                        key: Keyboard.keys.TAB,
                        ...
                        handler: function(t, e) {
                            ...
                            if (i) {
                                ...
                                if (u = s.match(/(^|\s)(https?:\/\/\S+)$/)) {
                                    ...
                                    if (d.length || a.formatText(t.index - c.length, c.length, "link", c, Quill.sources.USER), !s.substr(0, r - c.length).trim().length && "P" == i.domNode.tagName) {
                        ...
                        handler: function(t, e) {
                            ...
                            if (i && "P" == i.domNode.tagName) {
                                var r = i.offset(a.scroll),
                                    n = (new Delta).retain(r)["delete"](i.length()).insert({
                                        blockDivider: !0
                                    });
                                return i.next || n.insert("\n"), a.updateContents(n, Quill.sources.USER), !1
                            }
                            return !0
                        }
                    },
                    ...
                    "figure delete": {
                        ...
                        handler: function(t, e) {
                            var o = a.scroll.line(t.index),
                                ...
                                i = l[0];
                            l[1];
                            return !(i && i.prev && i.prev instanceof FigureBlot) || (e.empty && a.deleteText(t.index, 1, Quill.sources.USER), a.setSelection(i.prev.offset(a.scroll)), !1)
                        }
                    },
                    "field backspace": {
                        key: Keyboard.keys.BACKSPACE,
                        ...
                        handler: function(t, e) {
                            var o = a.scroll.line(t.index),
                                ...
                                i = l[0];
                            l[1];
                            return !(i && i.prev && i.prev instanceof FieldBlot && $(i.domNode).text().length > 0)
                        }
                    }
                }
            }
    ...
    return a.addContainer($tl_link_tooltip.get(0)), a.addContainer($tl_tooltip.get(0)), a.addContainer($tl_blocks.get(0)), a.on(Quill.events.EDITOR_CHANGE, function(t, e) {
        if (t === Quill.events.SELECTION_CHANGE && a.isEnabled() && null != e) {
            ...
            var o = a.scroll.descendant(Block, e.index),
                ...
                i = l[0];
            l[1];
            0 === e.length ? (hideFormatTooltip(), null == i || i instanceof FieldBlot || i instanceof BlockquoteBlot || i instanceof PullquoteBlot || i instanceof CodeBlock || i instanceof ListItem || $(i.domNode).text().length ? hideBlocksTooltip() : showBlocksTooltip(e)) : (null == i || i instanceof TitleBlot ? hideFormatTooltip() : (showFormatTooltip(e), toolbarUpdate(e)), hideBlocksTooltip());
            var r = a.getFormat(e);
            $tl_article.toggleClass("title_focused", !(!r.blockTitle && !r.blockAuthor)), checkOncePlaceholder()
        }
...
function savePage() {
    ...
    if (t.length < 2) {
        ...
        var l = quill.scroll.descendants(TitleBlot, 0, quill.scroll.length()),
            ...
            r = i[0];
        return quill.setSelection(r.offset(), r.length() - 1), quill.selection.scrollIntoView(), showError("Title is too small")
    }
...
function checkAuth() {
    ...
    $.ajax(T.apiUrl + "/check", {
        ...
        success: function(t) {
            if (t.save_hash && (T.saveHash = t.save_hash), (t.can_edit && T.saveHash || !T.pageId) && (t.short_name && $account.text(t.short_name), $tl_article.addClass("tl_article_editable")), !T.pageId && ($tl_article.addClass("tl_article_edit"), !draftGet() && t.author_name)) {
                ...
                var o = quill.scroll.descendants(AuthorBlot),
                    l = _slicedToArray(o, 1),
                    i = l[0];
                i && quill.updateContents((new Delta).retain(i.offset())["delete"](i.length()).insert(t.author_name, e), Quill.sources.USER)
            }
            if (t.auth_alert && t.short_name) {
                var r = "Success! You are now logged in as <b>" + htsc(t.short_name) + "</b> in this browser.";
                t.migrate_count > 0 && t.migrate_hash ? (r += "<br/><br/>", r += "We can also add " + t.migrate_count + " Telegraph page" + (t.migrate_count > 1 ? "s" : "") + " from this browser to your account.", showAlert(r, {
                    close_btn: "Skip",
                    submit_btn: "Add",
                    submit: function() {
...
function migratePages(t) {
    $.ajax(T.apiUrl + "/migrate", {
        ...
        success: function(t) {
            t.migrated_count > 0 ? showAlert("Added <b>" + t.migrated_count + "</b> Telegraph page" + (t.migrated_count > 1 ? "s" : "") + ' to your account.<br><br>To see a list of your pages, talk to the <a href="https://t.me/telegraph" target="_blank">@Telegraph</a> bot on Telegram.') : hideAlert()
        }
    })
}
...
function showAlert(t, e) {
    ...
    var o = $('<div class="tl_alert"><main class="tl_alert_message"><section></section><aside class="tl_message_buttons"></aside></main></div>');
    $("section", o).html(t);
    var l = $("aside", o);
    if (e.close_btn) {
    ...
    if (e.submit_btn) {
        ...
        r.html(e.submit_btn).click(function() {
...
function tooltipUpdatePosition(t, e, o) {
    if (o = o || {
        ...
        if ("top" == o.position) {
            ...
            var p = !1;
            r.top = l.bottom + o.padding, (p = isOverElement(r, o.depend, o.dependPadding)) && (r.top = p.bottom + o.dependPadding);
            var h = i.top + r.top;
            c = !0, h > s.top && (r.top = l.top - r.height - o.padding, (p = isOverElement(r, o.depend, o.dependPadding)) && (r.top = p.top - r.height - o.dependPadding), c = !1)
        }
        r.left = Math.round(r.left), r.top = Math.round(r.top), t._range = e, o.minDelta && Math.abs(r.left - t._left) < o.minDelta && Math.abs(r.top - t._top) < o.minDelta || (t._left = r.left, t._top = r.top, t.css({
            left: r.left,
            top: r.top
...
ListAuto.blotName = "list", ListAuto.defaultChild = "list-item", ListAuto.tagName = ["OL", "UL"], ListAuto.allowedChildren = [ListItem], Quill.register(ListAuto);
...
var AuthorBlot = function(t) {
    ...
    return _inherits(e, t), _createClass(e, [{
        key: "formatAt",
        value: function(t, o, l, i) {
            l === this.constructor.blotName ? _get(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "formatAt", this).call(this, t, o, l, i) : "link" === l && _get(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "formatAt", this).call(this, 0, this.length(), l, i)
        }
    }], [{
        key: "create",
        value: function(t) {
    ...
    function e(t, o) {
        ...
        return o.image ? (l.appendImgNode(o.image), i = l.uploadData(o.image)) : o.video ? (l.appendVideoNode(o.video), i = l.uploadData(o.video)) : o.embed && l.appendIframeNode(o.embed), i && (l.domProgress = document.createElement("div"), l.domProgressBar = document.createElement("div"), l.domProgress.classList.add("file_progress"), l.domProgressBar.classList.add("file_progress_bar"), l.domWrapper.classList.add("loading"), l.domProgress.appendChild(l.domProgressBar), l.domWrapper.appendChild(l.domProgress), l.uploadFile(i)), $(l.domWrapper).click(function() {
            ...
            if (e == Keyboard.keys.BACKSPACE) {
                ...
                quill.focus(), quill.insertText(i, "\n", Quill.sources.USER), quill.setSelection(i, 0, Quill.sources.USER), t.preventDefault()
            }
            ...
            if (e == Keyboard.keys.ENTER) {
                ...
                var i = o.selection("getPos"),
                    r = o.val();
                if (i.start != i.end) r = r.substr(0, i.start) + r.substr(i.end), o.val(r).selection("setPos", {
                    start: r.length,
                    end: r.length
                });
...
var MyQuill = function(t) {
        ...
        return _inherits(e, t), _createClass(e, [{
            key: "formatLine",
            value: function() {
                for (var t, o = arguments.length, l = Array(o), i = 0; i < o; i++) l[i] = arguments[i];
...
$tl_tooltip.mouseover(function(t) {
    ...
    if (i) {
        ...
        r || (i.domNode.setAttribute("data-placeholder", "Paste a YouTube, Vimeo or Twitter link, and press Enter"), $(i.domNode).addClass("placeholder_once empty"), hideBlocksTooltip())
    }
